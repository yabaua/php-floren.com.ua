...
{/if}
    ...
    <script type="module" crossorigin src="/assets/js/modulepreload-polyfill.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_swipers.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_shoelace.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_events.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_scroll2.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_catalog.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_clickOutside.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_expandableText.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/main.js?v=1"></script>
    <script type="module" crossorigin src="/assets/js/_forms.js?v=1"></script>

    <link rel="stylesheet" href="/assets/css/_swipers.css?3"/>
    <link rel="stylesheet" href="/assets/css/index.css?3"/>
            ...
            <sl-breadcrumb itemscope itemtype="http://schema.org/BreadcrumbList">
                {foreach item=H name=H from=$HLEB}
                  {if $smarty.foreach.H.iteration==1}
                    <sl-breadcrumb-item href="{if $LANGURL=='/ua'}/{else}/ru/{/if}" itemprop="item" itemscope
